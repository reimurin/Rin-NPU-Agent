...
def main():
    ...
    try:
        ...
        from build_wai_lora_layer_inputs import build_one
        manifest={'schema':1,'format':'rin-lora-module-banks-v1','soc':69,'dsp':79,'base_model':'WAI-illustrious-SDXL-v170','resolution':[1024,1024],'rank_capacity':args.rank,'stages':{},'compiled':False}
        ...
        for stage in ['encoder','decoder']:
            ...
            assert set(inputs)==set(spec['base_input_names']+spec['input_names']),inputs
            for module in spec['modules']:assert inputs[module['input_name']]==[module['input_elements']],module['module']
