...
class RuntimeDownloadForegroundService : Service() {
    ...
    private fun buildNotification(percent: Int, text: String): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle(getString(R.string.runtime_download_notification_title))
            .setContentText(text)
    ...
    companion object {
        private const val CHANNEL_ID = "rin_runtime_download"
        private const val NOTIFICATION_ID = 15102
        private const val ACTION_UPDATE = "com.geniex.demo.image.RUNTIME_DOWNLOAD_UPDATE"
        private const val ACTION_STOP = "com.geniex.demo.image.RUNTIME_DOWNLOAD_STOP"
        ...
        fun start(context: Context, text: String = context.getString(R.string.image_runtime_install_checking)) {
            val intent = Intent(context, RuntimeDownloadForegroundService::class.java)
        ...
        fun stop(context: Context) {
            context.stopService(Intent(context, RuntimeDownloadForegroundService::class.java))
        }
    }
}
