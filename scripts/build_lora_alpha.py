...
try:
 ...
 apk=out/'Rin-NPU-Agent-v1.6.0-alpha.2-debug-runtime-ready.apk'
 ...
 post.patch_apk(apk)
 report={'version':'1.6.0-alpha.2','code':19,'application_id':'com.geniex.demo','apk':str(apk),'bytes':apk.stat().st_size,'sha256':hashlib.sha256(apk.read_bytes()).hexdigest(),'phone_tested':False}
